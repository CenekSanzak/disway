...
const place_reducer = (state, action) => [
  {
    ...
    desc:"The Topkapı Palace or the Seraglio, is a large museum in Istanbul, Turkey. In the 15th century, it served as the main residence and administrative headquarters of the Ottoman sultans ",
    latitude: 41.013,
    longitude: 28.984,
    index: 0,
    priority: 1
  },
  {
    ...
    desc:"Sultan Ahmed Mosque also known as the Blue Mosque is a historic mosque located in Istanbul, Turkey. It remains a functioning mosque, while also attracting large numbers of tourist visitors. Hand-painted blue tiles adorn the mosque’s interior walls, and at night the mosque is bathed in blue as lights frame the mosque’s five main domes, six minarets and eight secondary domes. It sits next to the Hagia Sophia, another popular tourist site.",
    latitude: 41.005441,
    longitude: 28.976795,
    index: 1,
    priority: 1
